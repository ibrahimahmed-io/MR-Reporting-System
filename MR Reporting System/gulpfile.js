...
gulp.task('scripts2', function () {
    return gulp.src([
            ...
            'lib/jqxcalendar.js',
            'lib/jqxgrid.js',
            'lib/jqxgrid.aggregates.js',
            'lib/jqxgrid.columnsreorder.js',
            'lib/jqxgrid.columnsresize.js',
            'lib/jqxgrid.filter.js',
            'lib/jqxgrid.grouping.js',
            'lib/jqxgrid.pager.js',
            'lib/jqxgrid.selection.js',
            'lib/jqxgrid.sort.js',
            'lib/jqxgrid.storage.js',
            'lib/jqxmenu.js',
            'lib/jqxlistbox.js',
            'lib/jqxdatetimeinput.js',
            'lib/jqxdropdownlist.js',
            'lib/jqxdragdrop.js',
            'lib/jqxpanel.js',
            'lib/dropzone.js',
            ...
            'lib/smart.chat.manager.js',
            'lib/smart.chat.ui.js',
