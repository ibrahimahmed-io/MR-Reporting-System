define(['config'], function (config) {
    ...
    var excelExportingService = function (data, columns, fileName) {
        var zip = new JSZip();
        ...
        enumerableData.forEach(function (row, rowIndex) {
            sheet.append('<row r="' + (rowIndex + 1 + 1) + '">');
            columns.forEach(function (column, columnIndex) {
                ...
                sheet.append('<c r="' + availableColumns[columnIndex] + (rowIndex + 1 + 1) + '" t="' + columnType + '">');
    ...
    var wordExportingService = function (data, columns, fileName) {
        var zip = new JSZip();
    ...
    var pdfExportingService = function (data, columns, fileName) {
    ...
    var vm = {
        excelExportingService: excelExportingService,
        wordExportingService: wordExportingService,
        pdfExportingService: pdfExportingService
    };
